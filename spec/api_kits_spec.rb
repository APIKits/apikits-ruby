  ...
  describe '.parallel' do
    ...
    if defined?(::Typhoeus)
      ...
      it 'should raise an exception' do
        expect { ApiKits.parallel {} }.to raise_error(ApiKits::Exceptions::NotPossible)
      end
    end
  end

  context 'settings' do
    it 'should return the configured API URI' do
    ...
    it 'should have mock equal false' do
      ApiKits.config.mock.should be == false
    end

    it 'should have hydra equal false' do
      ApiKits.config.hydra.should be == false
    end
  end
